...
import "./ClientUserSettings.css";

import ArrowForwardIosIcon from "@mui/icons-material/ArrowForwardIos";
import { Box, Container, Grid, Switch } from "@mui/material";
import { Helmet } from "react-helmet";
import { ClientUserSettingMenu } from "../../../components/SuperAdmin/_client/";
export default function ClientUserSettings() {
  return (
    <Container maxWidth="xl">
      <div className="container-client-settings">
        ...
        <div className="top__items-settings">
          ...
          />
          <span style={{ paddingLeft: 10 }}> User Settings </span>
        </div>
