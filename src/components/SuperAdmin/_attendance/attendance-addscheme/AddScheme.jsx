  ...
  <div className="container-modal-keterlambatan">
    <div className="wrapper-modal-keterlambatan">
      <div className="card-max">
        ...
        <div className="item-sub-keterlambatan">
          <span className="box-input">09.00 AM</span>
        </div>
        <div className="main-text-keterlambatan">
          <span>To</span>
        </div>
        <div className="item-sub-keterlambatan">
          <span className="box-input">17.00 PM</span>
        </div>
        <div className="main-text-keterlambatan">
          <span>/ Day</span>
        </div>
      </div>
      <div className="note-text-cutoff">
        * Every client may have different default work time
      </div>
    </div>
  </div>
);
...
export default function AddScheme() {
  ...
  // const handleChange = (event) => {
  //   setListed({ ...listed, [event.target.checked]: event.target.checked });
  // };
  // const handleChange = (event) => {
  //   setListed({
  //     ...listed,
    ...
    <div className="container__add-scheme">
      ...
      <div className="main__add-scheme">
        <div className="wrapper__main-add-scheme">
          ...
          <Switch
            checked={defaultTime}
            onChange={handleDefaultTime}
            size="large"
            onClick={() => setDefaultTime({ default: !defaultTime.shown })}
          />
        </div>
        {defaultTime ? ModalDefaultTime : null}
        ...
        <div className="wrapper__main-add-scheme">
          <span>Overtime</span>
          <Switch checked={lembur} onChange={handleLembur} size="large" />
        </div>
        <div className="wrapper__main-add-scheme">
          <span>Paid Leave</span>
          <Switch checked={cuti} onChange={handleCuti} size="large" />
        </div>
        <div className="wrapper__main-add-scheme">
          <span>Permit</span>
          <Switch checked={off} onChange={handleOff} size="large" />
        </div>
        {/* <div className="wrapper__main-add-scheme">
          <span>Izin</span>
        ...
        <div className="wrapper__main-add-scheme">
          ...
          <Switch checked={jamKerja} onChange={handleJamKerja} size="large" />
        </div>
        <div className="wrapper__main-add-scheme">
          <span>Lateness</span>
          <Switch
